 ...
 * Generated for Laravel 5.2.22 on 2016-07-25.
 *
...
namespace {
    ...
    class Queue extends \Illuminate\Support\Facades\Queue{
        ...
        public static function push($job, $data = '', $queue = null){
            return \Mayconbordin\L5StompQueue\StompQueue::push($job, $data, $queue);
        }
        ...
        public static function pushRaw($payload, $queue = null, $options = array()){
            return \Mayconbordin\L5StompQueue\StompQueue::pushRaw($payload, $queue, $options);
        }
         ...
         * @static 
         */
        public static function recreate($payload, $queue, $delay){
            return \Mayconbordin\L5StompQueue\StompQueue::recreate($payload, $queue, $delay);
        }
        ...
        public static function later($delay, $job, $data = '', $queue = null){
            return \Mayconbordin\L5StompQueue\StompQueue::later($delay, $job, $data, $queue);
        }
         ...
         *
         * @param string $queue
         * @return \Mayconbordin\L5StompQueue\StompJob|null 
         * @static 
         */
        public static function pop($queue = null){
            return \Mayconbordin\L5StompQueue\StompQueue::pop($queue);
        }
         ...
         *
         * @param string $queue
         * @param string|\Mayconbordin\L5StompQueue\Frame $message
         * @return void 
         * @static 
         */
        public static function deleteMessage($queue, $message){
            \Mayconbordin\L5StompQueue\StompQueue::deleteMessage($queue, $message);
        }
        ...
        public static function getQueue($queue){
            return \Mayconbordin\L5StompQueue\StompQueue::getQueue($queue);
        }
        
        /**
         * 
         *
         * @return \Mayconbordin\L5StompQueue\Stomp 
         * @static 
         */
        public static function getStomp(){
            return \Mayconbordin\L5StompQueue\StompQueue::getStomp();
        }
        ...
        public static function pushOn($queue, $job, $data = ''){
            ...
            return \Mayconbordin\L5StompQueue\StompQueue::pushOn($queue, $job, $data);
        }
        ...
        public static function laterOn($queue, $delay, $job, $data = ''){
            //Method inherited from \Illuminate\Queue\Queue            
            return \Mayconbordin\L5StompQueue\StompQueue::laterOn($queue, $delay, $job, $data);
        }
        ...
        public static function bulk($jobs, $data = '', $queue = null){
            //Method inherited from \Illuminate\Queue\Queue            
            return \Mayconbordin\L5StompQueue\StompQueue::bulk($jobs, $data, $queue);
        }
        ...
        public static function setContainer($container){
            //Method inherited from \Illuminate\Queue\Queue            
            \Mayconbordin\L5StompQueue\StompQueue::setContainer($container);
        }
        ...
        public static function setEncrypter($crypt){
            //Method inherited from \Illuminate\Queue\Queue            
            \Mayconbordin\L5StompQueue\StompQueue::setEncrypter($crypt);
        }
    ...
    class CLog extends \App\Libraries\CLogger\CLog{
        
    }


    class CurlShopApi extends \App\Facades\CurlShopApi{
         ...
         * @static 
         */
        public static function curlShopApi($uri, $method, $data = array()){
            return \App\CurlShopApi::curlShopApi($uri, $method, $data);
        }
        ...
        public static function get($uri){
            return \App\CurlShopApi::get($uri);
        }
        ...
        public static function post($uri, $data = array()){
            return \App\CurlShopApi::post($uri, $data);
        }
        ...
        public static function put($uri, $data = array()){
            return \App\CurlShopApi::put($uri, $data);
        }
         ...
         * @static 
         */
        public static function del($uri, $data = array()){
            return \App\CurlShopApi::del($uri, $data);
        }
        ...
        public static function clearBootedModels(){
            ...
            \App\CurlShopApi::clearBootedModels();
        }
        ...
        public static function addGlobalScope($scope, $implementation = null){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::addGlobalScope($scope, $implementation);
        }
        ...
        public static function hasGlobalScope($scope){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::hasGlobalScope($scope);
        }
        ...
        public static function getGlobalScope($scope){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getGlobalScope($scope);
        }
        ...
        public static function getGlobalScopes(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getGlobalScopes();
        }
        ...
        public static function observe($class, $priority = 0){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            \App\CurlShopApi::observe($class, $priority);
        }
        ...
        public static function fill($attributes){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::fill($attributes);
        }
        ...
        public static function forceFill($attributes){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::forceFill($attributes);
        }
        ...
        public static function newInstance($attributes = array(), $exists = false){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::newInstance($attributes, $exists);
        }
        ...
        public static function newFromBuilder($attributes = array(), $connection = null){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::newFromBuilder($attributes, $connection);
        }
        ...
        public static function hydrate($items, $connection = null){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::hydrate($items, $connection);
        }
        ...
        public static function hydrateRaw($query, $bindings = array(), $connection = null){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::hydrateRaw($query, $bindings, $connection);
        }
        ...
        public static function create($attributes = array()){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::create($attributes);
        }
        ...
        public static function forceCreate($attributes){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::forceCreate($attributes);
        }
        ...
        public static function on($connection = null){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::on($connection);
        }
        ...
        public static function onWriteConnection(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::onWriteConnection();
        }
        ...
        public static function all($columns = array()){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::all($columns);
        }
        ...
        public static function fresh($with = array()){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::fresh($with);
        }
        ...
        public static function load($relations){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::load($relations);
        }
        ...
        public static function with($relations){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::with($relations);
        }
        ...
        public static function append($attributes){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::append($attributes);
        }
        ...
        public static function hasOne($related, $foreignKey = null, $localKey = null){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::hasOne($related, $foreignKey, $localKey);
        }
        ...
        public static function morphOne($related, $name, $type = null, $id = null, $localKey = null){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::morphOne($related, $name, $type, $id, $localKey);
        }
        ...
        public static function belongsTo($related, $foreignKey = null, $otherKey = null, $relation = null){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::belongsTo($related, $foreignKey, $otherKey, $relation);
        }
        ...
        public static function morphTo($name = null, $type = null, $id = null){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::morphTo($name, $type, $id);
        }
        ...
        public static function getActualClassNameForMorph($class){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getActualClassNameForMorph($class);
        }
        ...
        public static function hasMany($related, $foreignKey = null, $localKey = null){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::hasMany($related, $foreignKey, $localKey);
        }
        ...
        public static function hasManyThrough($related, $through, $firstKey = null, $secondKey = null, $localKey = null){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::hasManyThrough($related, $through, $firstKey, $secondKey, $localKey);
        }
        ...
        public static function morphMany($related, $name, $type = null, $id = null, $localKey = null){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::morphMany($related, $name, $type, $id, $localKey);
        }
        ...
        public static function belongsToMany($related, $table = null, $foreignKey = null, $otherKey = null, $relation = null){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::belongsToMany($related, $table, $foreignKey, $otherKey, $relation);
        }
        ...
        public static function morphToMany($related, $name, $table = null, $foreignKey = null, $otherKey = null, $inverse = false){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::morphToMany($related, $name, $table, $foreignKey, $otherKey, $inverse);
        }
        ...
        public static function morphedByMany($related, $name, $table = null, $foreignKey = null, $otherKey = null){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::morphedByMany($related, $name, $table, $foreignKey, $otherKey);
        }
        ...
        public static function joiningTable($related){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::joiningTable($related);
        }
        ...
        public static function destroy($ids){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::destroy($ids);
        }
        ...
        public static function forceDelete(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::forceDelete();
        }
        ...
        public static function saving($callback, $priority = 0){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            \App\CurlShopApi::saving($callback, $priority);
        }
        ...
        public static function saved($callback, $priority = 0){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            \App\CurlShopApi::saved($callback, $priority);
        }
        ...
        public static function updating($callback, $priority = 0){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            \App\CurlShopApi::updating($callback, $priority);
        }
        ...
        public static function updated($callback, $priority = 0){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            \App\CurlShopApi::updated($callback, $priority);
        }
        ...
        public static function creating($callback, $priority = 0){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            \App\CurlShopApi::creating($callback, $priority);
        }
        ...
        public static function created($callback, $priority = 0){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            \App\CurlShopApi::created($callback, $priority);
        }
        ...
        public static function deleting($callback, $priority = 0){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            \App\CurlShopApi::deleting($callback, $priority);
        }
        ...
        public static function deleted($callback, $priority = 0){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            \App\CurlShopApi::deleted($callback, $priority);
        }
        ...
        public static function flushEventListeners(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            \App\CurlShopApi::flushEventListeners();
        }
        ...
        public static function getObservableEvents(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getObservableEvents();
        }
        ...
        public static function setObservableEvents($observables){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::setObservableEvents($observables);
        }
        ...
        public static function addObservableEvents($observables){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            \App\CurlShopApi::addObservableEvents($observables);
        }
        ...
        public static function removeObservableEvents($observables){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            \App\CurlShopApi::removeObservableEvents($observables);
        }
        ...
        public static function update($attributes = array(), $options = array()){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::update($attributes, $options);
        }
        ...
        public static function save($options = array()){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::save($options);
        }
        ...
        public static function saveOrFail($options = array()){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::saveOrFail($options);
        }
        ...
        public static function touches($relation){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::touches($relation);
        }
        ...
        public static function setCreatedAt($value){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::setCreatedAt($value);
        }
        ...
        public static function setUpdatedAt($value){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::setUpdatedAt($value);
        }
        ...
        public static function getCreatedAtColumn(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getCreatedAtColumn();
        }
        ...
        public static function getUpdatedAtColumn(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getUpdatedAtColumn();
        }
        ...
        public static function freshTimestamp(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::freshTimestamp();
        }
        ...
        public static function freshTimestampString(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::freshTimestampString();
        }
        ...
        public static function newQuery(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::newQuery();
        }
        ...
        public static function newQueryWithoutScope($scope){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::newQueryWithoutScope($scope);
        }
        ...
        public static function newQueryWithoutScopes(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::newQueryWithoutScopes();
        }
        ...
        public static function newEloquentBuilder($query){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::newEloquentBuilder($query);
        }
        ...
        public static function newCollection($models = array()){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::newCollection($models);
        }
        ...
        public static function newPivot($parent, $attributes, $table, $exists){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::newPivot($parent, $attributes, $table, $exists);
        }
        ...
        public static function getTable(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getTable();
        }
        ...
        public static function setTable($table){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::setTable($table);
        }
        ...
        public static function getQueueableId(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getQueueableId();
        }
        ...
        public static function getKeyName(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getKeyName();
        }
        ...
        public static function setKeyName($key){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::setKeyName($key);
        }
        ...
        public static function getQualifiedKeyName(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getQualifiedKeyName();
        }
        ...
        public static function getRouteKey(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getRouteKey();
        }
        ...
        public static function getRouteKeyName(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getRouteKeyName();
        }
        ...
        public static function usesTimestamps(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::usesTimestamps();
        }
        ...
        public static function getMorphClass(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getMorphClass();
        }
        ...
        public static function getPerPage(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getPerPage();
        }
        ...
        public static function setPerPage($perPage){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::setPerPage($perPage);
        }
        ...
        public static function getForeignKey(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getForeignKey();
        }
        ...
        public static function getHidden(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getHidden();
        }
        ...
        public static function setHidden($hidden){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::setHidden($hidden);
        }
        ...
        public static function addHidden($attributes = null){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            \App\CurlShopApi::addHidden($attributes);
        }
        ...
        public static function makeVisible($attributes){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::makeVisible($attributes);
        }
        ...
        public static function withHidden($attributes){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::withHidden($attributes);
        }
        ...
        public static function getVisible(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getVisible();
        }
        ...
        public static function setVisible($visible){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::setVisible($visible);
        }
        ...
        public static function addVisible($attributes = null){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            \App\CurlShopApi::addVisible($attributes);
        }
        ...
        public static function setAppends($appends){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::setAppends($appends);
        }
        ...
        public static function getFillable(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getFillable();
        }
        ...
        public static function fillable($fillable){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::fillable($fillable);
        }
        ...
        public static function getGuarded(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getGuarded();
        }
        ...
        public static function guard($guarded){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::guard($guarded);
        }
        ...
        public static function isUnguarded(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::isUnguarded();
        }
        ...
        public static function unguarded($callback){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::unguarded($callback);
        }
        ...
        public static function isFillable($key){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::isFillable($key);
        }
        ...
        public static function isGuarded($key){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::isGuarded($key);
        }
        ...
        public static function totallyGuarded(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::totallyGuarded();
        }
        ...
        public static function getTouchedRelations(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getTouchedRelations();
        }
        ...
        public static function setTouchedRelations($touches){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::setTouchedRelations($touches);
        }
        ...
        public static function getIncrementing(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getIncrementing();
        }
        ...
        public static function setIncrementing($value){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::setIncrementing($value);
        }
        ...
        public static function toJson($options = 0){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::toJson($options);
        }
        ...
        public static function jsonSerialize(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::jsonSerialize();
        }
        ...
        public static function toArray(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::toArray();
        }
        ...
        public static function attributesToArray(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::attributesToArray();
        }
        ...
        public static function relationsToArray(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::relationsToArray();
        }
        ...
        public static function getAttribute($key){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getAttribute($key);
        }
        ...
        public static function getAttributeValue($key){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getAttributeValue($key);
        }
        ...
        public static function getRelationValue($key){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getRelationValue($key);
        }
        ...
        public static function hasGetMutator($key){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::hasGetMutator($key);
        }
        ...
        public static function hasCast($key, $types = null){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::hasCast($key, $types);
        }
        ...
        public static function getCasts(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getCasts();
        }
        ...
        public static function setAttribute($key, $value){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::setAttribute($key, $value);
        }
        ...
        public static function hasSetMutator($key){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::hasSetMutator($key);
        }
        ...
        public static function getDates(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getDates();
        }
        ...
        public static function fromDateTime($value){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::fromDateTime($value);
        }
        ...
        public static function setDateFormat($format){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::setDateFormat($format);
        }
        ...
        public static function fromJson($value, $asObject = false){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::fromJson($value, $asObject);
        }
        ...
        public static function replicate($except = null){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::replicate($except);
        }
        ...
        public static function getAttributes(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getAttributes();
        }
        ...
        public static function setRawAttributes($attributes, $sync = false){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::setRawAttributes($attributes, $sync);
        }
        ...
        public static function getOriginal($key = null, $default = null){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getOriginal($key, $default);
        }
        ...
        public static function syncOriginal(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::syncOriginal();
        }
        ...
        public static function syncOriginalAttribute($attribute){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::syncOriginalAttribute($attribute);
        }
        ...
        public static function isDirty($attributes = null){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::isDirty($attributes);
        }
        ...
        public static function getDirty(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getDirty();
        }
        ...
        public static function getRelations(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getRelations();
        }
        ...
        public static function getRelation($relation){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getRelation($relation);
        }
        ...
        public static function relationLoaded($key){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::relationLoaded($key);
        }
        ...
        public static function setRelation($relation, $value){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::setRelation($relation, $value);
        }
        ...
        public static function setRelations($relations){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::setRelations($relations);
        }
        ...
        public static function getConnection(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getConnection();
        }
        ...
        public static function getConnectionName(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getConnectionName();
        }
        ...
        public static function setConnection($name){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::setConnection($name);
        }
        ...
        public static function resolveConnection($connection = null){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::resolveConnection($connection);
        }
        ...
        public static function getConnectionResolver(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getConnectionResolver();
        }
        ...
        public static function setConnectionResolver($resolver){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            \App\CurlShopApi::setConnectionResolver($resolver);
        }
        ...
        public static function unsetConnectionResolver(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            \App\CurlShopApi::unsetConnectionResolver();
        }
        ...
        public static function getEventDispatcher(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getEventDispatcher();
        }
        ...
        public static function setEventDispatcher($dispatcher){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            \App\CurlShopApi::setEventDispatcher($dispatcher);
        }
        ...
        public static function unsetEventDispatcher(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            \App\CurlShopApi::unsetEventDispatcher();
        }
        ...
        public static function getMutatedAttributes(){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::getMutatedAttributes();
        }
        ...
        public static function cacheMutatedAttributes($class){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            \App\CurlShopApi::cacheMutatedAttributes($class);
        }
        ...
        public static function offsetExists($offset){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::offsetExists($offset);
        }
        ...
        public static function offsetGet($offset){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            return \App\CurlShopApi::offsetGet($offset);
        }
        ...
        public static function offsetSet($offset, $value){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            \App\CurlShopApi::offsetSet($offset, $value);
        }
        ...
        public static function offsetUnset($offset){
            //Method inherited from \Illuminate\Database\Eloquent\Model            
            \App\CurlShopApi::offsetUnset($offset);
        }
        
    }


    class Burp extends \Zofe\Burp\Burp{
        
    }


    class BurpEvent extends \Zofe\Burp\BurpEvent{
    ...
    class Rapyd extends \Zofe\Rapyd\Facades\Rapyd{
        ...
        public static function styles($demo = false){
            return \Zofe\Rapyd\Rapyd::styles($demo);
        }
        ...
        public static function tag($tag){
            return \Zofe\Rapyd\Rapyd::tag($tag);
        }
    ...
    class DataSet extends \Zofe\Rapyd\Facades\DataSet{
        ...
        public static function addOrderBy($fieldname){
            return \Zofe\Rapyd\DataSet::addOrderBy($fieldname);
        }
    ...
    class DataGrid extends \Zofe\Rapyd\Facades\DataGrid{
        ...
        public static function addOrderBy($fieldname){
            //Method inherited from \Zofe\Rapyd\DataSet            
            return \Zofe\Rapyd\DataGrid\DataGrid::addOrderBy($fieldname);
        }
    ...
    class DataForm extends \Zofe\Rapyd\Facades\DataForm{
         ...
         * @static 
         */
        public static function hasCustomOutput(){
            return \Zofe\Rapyd\DataForm\DataForm::hasCustomOutput();
        }
         ...
         * @static 
         */
        public static function view($viewname = 'rapyd::form', $array = array()){
    ...
    class DataEdit extends \Zofe\Rapyd\Facades\DataEdit{
        ...
        public static function hasCustomOutput(){
            //Method inherited from \Zofe\Rapyd\DataForm\DataForm            
            return \Zofe\Rapyd\DataEdit\DataEdit::hasCustomOutput();
        }
    ...
    class DataFilter extends \Zofe\Rapyd\Facades\DataFilter{
        ...
        public static function hasCustomOutput(){
            //Method inherited from \Zofe\Rapyd\DataForm\DataForm            
            return \Zofe\Rapyd\DataFilter\DataFilter::hasCustomOutput();
        }
    ...
    class DataEmbed extends \Zofe\Rapyd\Facades\DataEmbed{
        ...
        public static function source($url, $id){
            return \Zofe\Rapyd\DataEmbed::source($url, $id);
        }
